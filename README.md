BioLens is a software that can be used to clean and visualize data packages downloaded from wildlife insight.  As of this initial release, it contains 2 python scripts to run the data set, but in the future a proper front end will be implemented.
